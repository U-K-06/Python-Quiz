function Question() {
const className =
  "bg-card-option-default rounded-2xl text-4xl w-11/12 text-center h-14  flex items-center justify-center hover:bg-gray-950";


  return (
    <div className="flex items-center justify-center min-h-screen bg-background p-4">
      <div className="bg-card-question border border-border rounded-2xl w-full max-w-4xl p-8 space-y-8">
        <p className="text-center text-text-primary font-bold text-2xl sm:text-3xl lg:text-4xl">
          What is Your Name?
        </p>

        <p className="border-l-8 border-primary bg-text-secondary text-text-primary p-4 rounded-md text-2xl">
