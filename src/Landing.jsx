...
<ul className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6'>
  ...
  {/* The UNSELECTED state now uses !bg-card-option-default (#111827) */}
  <li onClick={()=>selectTopic(0)} 
    ...
    <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-blockquote-left" viewBox="0 0 16 16">
  ...
  <li onClick={()=>selectTopic(1)} 
   ...
   <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-ul" viewBox="0 0 16 16">
  ...
  <li onClick={()=>selectTopic(2)} 
    ...
    <img src={dict} alt="dictionary-icon" className='w-10 h-10' />
  </li>
  ...
  <li onClick={()=>selectTopic(3)} 
    ...
    <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-clockwise" viewBox="0 0 16 16">
  ...
  <li onClick={()=>selectTopic(4)} 
    ...
    <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-union" viewBox="0 0 16 16">
  ...
  <li onClick={()=>selectTopic(5)} 
    ...
    <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-code-slash" viewBox="0 0 16 16">
  ...
  <li onClick={()=>selectTopic(6)} 
    ...
    <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
  ...
  <li onClick={()=>selectTopic(7)} 
    ...
    <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-diagram-3" viewBox="0 0 16 16">
  ...
  <li onClick={()=>selectTopic(8)} 
    ...
    <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder-symlink" viewBox="0 0 16 16">
  ...
  <li onClick={()=>selectTopic(9)} 
   ...
   <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe2" viewBox="0 0 16 16">
  ...
  <li onClick={()=>selectTopic(10)} 
    ...
    <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-braces" viewBox="0 0 16 16">
